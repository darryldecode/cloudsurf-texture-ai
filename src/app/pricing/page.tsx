  ...
  return (
    <PublicPageShell>
      <PageHero
        ...
        body="Buy credits as you need them. Pack prices are set against our OpenAI image generation cost baseline so the service can stay reliable while still giving you room to experiment."
      />
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 text-sm leading-6 text-[var(--muted)]">
              New accounts include 10 starting credits. Purchased credits are added after Paddle confirms payment, and generation debits happen only when a request starts.
            </p>
          </div>
